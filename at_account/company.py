...
class res_company(osv.osv):
    ...
    _columns = {
        ...
        "account_customer_seq_id": fields.many2one(
            "ir.sequence", "Customer Account Sequence"
        ),
        "account_supplier_seq_id": fields.many2one(
            "ir.sequence", "Supplier Account Sequence"
        ),
    }
    _defaults = {"fiscal_auto_year": True, "fiscal_auto_seq": True}
    ...
    def create_fiscalyear(self, cr, uid, ids, year, context=None):
        ...
        for company in self.browse(cr, uid, ids, context=context):
            ...
            for journal in journal_obj.browse(cr, uid, journal_ids, context=context):
                ...
                fiscalyear_sequence_ids = fiscal_sequence_obj.search(
                    cr,
                    uid,
                    [
